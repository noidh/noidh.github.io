...
\usepackage[left=0.1in,top=0.1in,right=0.25in,bottom=0.1in]{geometry}
\usepackage{enumitem}
\usepackage{hyperref}
\hypersetup{
    colorlinks=true,
...
\name{DOAN HUU NOI}
\address{doanhuunoi@gmail.com \\  \url{noidh.github.io}\\  +65-8434-2003} 
...
\begin{document}
	...
	\begin{rSection}{Education}
		...
		{\bf Post and Telecom. Institute of Technology, HCM City, Vietnam} \hfill {\em Sept 2008 - Jan 2013} \\  {Bachelor's Degree in Information Technology.}
	\end{rSection}
	...
	\begin{rSection}{Experience}
		\begin{rSubsection}{Zoom}{Nov. 2022 - Current}{Video Processing Software  Engineer}{Singapore}
			...
			\item Working on 3D telepresence project:\\
			- Conducted the system setup: camera setup,  intrinsic calibration, stereo calibration, multiple cameras synchronization.\\
			- Conducted the data collection: collected synthetic (1,500+ subject ids) and real (60+ person ids) datasets.\\
			- Improved model performance: implemented a half-resolution version 30\% faster, achieved 3× speed-up by using TensorRT, improved 3D geometry by using normap consistency loss, improved occlusion case.\\
			- Designed and implemented a Python-based demo pipeline (to be ported to C++), using PyTorch and OpenGL; accelerated  10× faster display speed by GPU tensor rendering.
			\item \underline{Tech Stack:} C++, Python, Pytorch, SIMD, TensorRT, Open3D, OpenCV, OpenGL, Pytorch3D, Video Processing, Deep Learning, 3D Rendering, 3D Gaussian Splatting,  Depth Estimation,  Model Deployment.
...
- Developing fast convolution and morphology operations using SIMD and In-place Processing. \\
	...
	\begin{rSection}{Personal Projects}
		...
		\\ I write many articles not only to share my knowledge about Image Processing, Computer Vision, Machine Learning, 3D Rendering and other miscellaneous but also to learn new technologies.  I also develop a simple application to intuitively demonstrate how these algorithms work.
