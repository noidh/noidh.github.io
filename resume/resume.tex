...
\begin{document}
	...
	\begin{rSection}{Experience}
		\begin{rSubsection}{Zoom}{Nov. 2022 - Current}{Video Processing Software  Engineer}{Singapore}
			...
			- Improved model performance: implemented a half-resolution version 30\% faster, achieved 3× speed-up with TensorRT, improved 3D geometry by using normap consistency loss.\\
